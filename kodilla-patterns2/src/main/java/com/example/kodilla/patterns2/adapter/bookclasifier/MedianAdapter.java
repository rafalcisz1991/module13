...
public class MedianAdapter extends MedianAdaptee implements Classifier {
    ...
    @Override
    public int publicationYearMedian(Set<com.example.kodilla.patterns2.adapter.bookclasifier.librarya.Book> bookSet) {
        Map <BookSignature, Book> books = new HashMap<>();
        for (com.example.kodilla.patterns2.adapter.bookclasifier.librarya.Book book : bookSet) {
